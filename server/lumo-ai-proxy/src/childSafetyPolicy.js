...
export const blockedTopicRules = [
  {
    id: 'sexual_content',
    severity: 'block',
    terms: ['sex', 'sexy', 'porno', 'pornografie', 'nackt', 'nacktbilder', 'onlyfans', 'kuessen mit zunge', 'vergewaltigung'],
  ...
  },
  {
    ...
    severity: 'block',
    terms: ['krieg', 'waffe', 'messer', 'pistole', 'bombe', 'toeten', 'mord', 'blut', 'hinrichten', 'folter', 'anschlag'],
  ...
  },
  {
    ...
    terms: ['ich will sterben', 'mich umbringen', 'suizid', 'selbstmord', 'ritzen', 'mir weh tun'],
  ...
  },
  {
    ...
    severity: 'block',
    terms: ['partei', 'wahlkampf', 'hitler', 'nazi', 'terror', 'extremismus', 'propaganda'],
  ...
  },
  {
    id: 'drugs_alcohol',
    severity: 'block',
    terms: ['drogen', 'kiffen', 'kokain', 'heroin', 'alkohol trinken', 'betrunken', 'zigarette', 'vape'],
    redirect: 'Das ist kein Kinderthema. Lass uns ueber gesunde Gewohnheiten, Sport oder eine Lernaufgabe sprechen.',
  },
  {
    id: 'private_data',
    severity: 'block',
    terms: ['adresse', 'telefonnummer', 'passwort', 'bankkarte', 'kreditkarte', 'pin code', 'geheimnis verraten'],
