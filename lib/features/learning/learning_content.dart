...
class _LearningContentState extends State<LearningContent> {
  ...
  LumoTask _nextTask() {
    ...
    return _factory.next(
      grade: st.grade,
      subject: st.subject == 'Alle' ? 'Mathematik' : st.subject,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    st.subject == 'Alle' ? 'Test' : st.subject,
                  ...
                  const Text(
                    'Arbeite wie im Heft.\nRuhig lesen, dann erst antworten.',
                    style: TextStyle(
                      fontFamily: 'Nunito',
                      fontSize: 14,
          ...
          if (_answered && _picked != null) ...[
            const SizedBox(height: 22),
            _ExplanationCard(
              correct: _picked == _task.answer,
              explanation: _task.explanation,
              correctAnswer: _task.answer,
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            ...
            children: [
              ...
              if (widget.answered && isPicked && !isCorrect)
                const Padding(
                  padding: EdgeInsets.only(right: 6),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Text(
              correct ? 'Super gemacht! ⭐' : 'Fast – nicht aufgeben!',
              style: TextStyle(
                fontFamily: 'Nunito',
                fontSize: 17,
                fontWeight: FontWeight.w900,
